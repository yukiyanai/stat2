...
- 2024年度の講義は非常勤講師の[宋財泫（ソン・ジェヒョン）](https://www.jaysong.net/)先生に担当してもらう。
    - 講義計画・講義資料の入手方法等については、第1回の授業で説明されるので、宋先生の指示に従うこと。
...
授業の内容は、10のトピックに分かれている。[2023年度版シラバス (PDF)](https://yukiyanai.github.io/jp/classes/stat2/docs/syllabus-stat2_2023-3Q.pdf) にはトピックごとの予習課題と参考文献が記載されている。 各トピックとこのウェブ資料の対応は以下の通りである。
